...
export const sendAction: ActionFunction = async ({ request, params }) => {
  ...
  const stringCache = new Map<string, renderStringCache[]>();
  const renderedResult = await tryToInterpolateRequest(req, environment._id, RENDER_PURPOSE_SEND, undefined, stringCache);
